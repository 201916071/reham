  ...
  <img id="logo" src="logoo.png" alt="logo">
    ...
    <div class="center">
      <form action="">
        ...
        <span class="inputs">
          <span class="inputf">
           <input type="first name" class="input" placeholder="First Name" />
           <span class="label">first name</span>
           <span class="material-icons icon">first name</span>
          </span>
          <span class="inputs">
           <span class="inputf">
           <input type="last name" class="input" placeholder="Last Name" />
           <span class="label">last name</span>
           <span class="material-icons icon">last name</span>
          </span>
          <span class="inputs">
           <span class="inputf">
          ...
          <span class="inputf">
            <input type="confirm password" class="input" placeholder="Confirm Password" />
            <span class="label">confirm password</span>
            <span class="material-icons icon">lock</span>
          </span>
        </span>
        <button type="button" class="btn" >
        <a href="http://localhost/project/enter.php"><span>Register</span></a>
          <div class="dots">
        ...
        <div class="text">
           Already have account <a href="http://localhost/project/LoginPage.php">Login</a>
        </div>
      </form>
    </div>
    <script>
